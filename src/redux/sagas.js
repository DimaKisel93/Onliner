...
import { REQUEST_CARS, SET_ALL_CARS, FILTER_PRODUCTS_BY_BRAND, FILTER_PRODUCTS_BRAND , FILTER_PRODUCTS_MODEL, FILTER_PRODUCTS_BY_MODEL, ORDER_PRODUCTS, ORDER_PRODUCTS_BY_SPEED, REQUEST_CAR, SET_CAR} from './constants';
...
export function* sagaWatcher(){
    try {
        ...
        yield takeEvery(FILTER_PRODUCTS_BRAND, sagaWorkerFilterBrand)
...
function* sagaWorkerFilterBrand(cars){
